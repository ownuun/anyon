...
icon: https://www.anyon.dev/images/logos/factory-ai-logo-light.png
---
...
<Step title="Authenticate with Factory AI">
  To use Droid in Anyon, you must first authenticate:
...
Droid supports several configuration options in Anyon:
...
These options can be configured when creating agent configurations in Anyon.
