...
<Step title="Install Web Companion">
  For precise component selection, install the `anyon-web-companion` package in your application.
  ...
  **Manual Installation:**
  ...
  ```bash
  npm install anyon-web-companion
  ```
...
<Frame>
<img src="/images/anyon-preview-interface.png" alt="Preview mode showing embedded application with toolbar controls" />
</Frame>
...
<Frame>
<img src="/images/anyon-preview-toolbar.png" alt="Preview toolbar showing refresh, copy URL, open in browser, and stop server controls" />
</Frame>
...
<Frame>
<img src="/images/anyon-dev-server-logs.png" alt="Dev Server Logs showing expandable/collapsible log output at bottom of preview" />
</Frame>
...
<Step title="Activate Selection Mode">
  ...
  <Frame>
  <img src="/images/anyon-component-selection.png" alt="Component selection interface showing selectable elements highlighted" />
  </Frame>
</Step>
