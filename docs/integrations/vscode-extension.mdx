...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=slit.anyon">
...
<Card title="Open VSX Registry" icon="download" href="https://open-vsx.org/extension/slit/anyon">
...
**Solution**: Ensure you're working within a worktree created by an Anyon task.
...
**Steps to resolve**:
1. Verify you opened VSCode through the "Open in [IDE]" button from an Anyon task
...
**Solutions**:
- Verify the extension is installed by searching `@id:slit.anyon` in Extensions
...
<Info>
The extension is designed to work with any VSCode-compatible editor. If you're using a different VSCode fork, try installing from Open VSX Registry using the extension ID `slit.anyon`.
</Info>
