...
<Frame>
<img src="/images/anyon-mcp-server-config.jpeg" alt="MCP Server configuration page showing available servers and one-click installation options" />
</Frame>
...
<Frame>
<img src="/images/anyon-popular-mcp-servers.png" alt="Popular MCP servers available for one-click installation" />
</Frame>
